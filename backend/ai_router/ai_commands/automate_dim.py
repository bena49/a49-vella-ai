...
def handle_automate_dim(request):
    ...
    Expected request.data keys:
        ...
        - offset_mm:            int  (default 800) -- spacing between exterior layers
        - inset_mm:             int  (default 1000) -- offset for Layer 3 interior string
    ...
    offset_mm          = request.data.get("offset_mm", 1200)
    inset_mm           = request.data.get("inset_mm", 1500)
